...
function configureText() {
    ...
    if (script.addText) {
        ...
        var textScreenTransform = script.textComponent.getSceneObject().getComponent("Component.ScreenTransform");
...
function configureParticles() {
    if (script.addParticles) {
        ...
        for (var i = 0; i < scriptComponents.length; i++) {
            ...
            scriptComponent.api.particleAlpha = script.particleAlpha;
        }
    } else {
